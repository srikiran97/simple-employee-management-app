...
class _EditEmployeeDetailsState extends State<EditEmployeeDetails> {
  ...
  @override
  void initState() {
    _textController = TextEditingController(text: widget.employee.employeeName);
    _selectedRole = widget.employee.role;
    startDate = widget.employee.startDate;
    endDate = widget.employee.endDate ?? 'No date';
    super.initState();
  }
              ...
              IconButton(
                  onPressed: () {
                    context
                        ...
                        .add(RemoveEmployeeEvent(widget.employee));
                    Navigator.of(context).pop(widget.employee);
                  },
                  icon: SvgPicture.asset(
                    'assets/dismiss_icon.svg',
                    width: 15,
                    height: 17,
                  ))
            ],
